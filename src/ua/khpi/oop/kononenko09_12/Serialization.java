...
public class Serialization {
    ...
    public static <E extends Trip> MyLinkedList<E> LongTermPersistenceRead(String path) throws FileNotFoundException {
        boolean test = true;
    ...
    public static <E extends Trip> void ObjectWrite(MyLinkedList<E> object, String path) throws IOException, ClassNotFoundException {
