...
import ua.khpi.oop.kononenko09_12.Station;
import ua.khpi.oop.kononenko09_12.Input;
import ua.khpi.oop.kononenko09_12.Files;
...
public class Helper {
    ...
    private static ArrayList<Trip> object = new ArrayList<>();
    ...
    @SuppressWarnings("unchecked")
    private static void save(ArrayList<Trip> input) {
        int choose;
    ...
    @SuppressWarnings("unchecked")
    private static void sorters(ArrayList input) {
        int choose;
    ...
    private static void settingSearch(ArrayList<Trip> input) {
    ...
    private static void remove(ArrayList<Trip> input) {
        int num;
        if (input.size() != 0) {
    ...
    private static void clear(ArrayList<Trip> input) {
    ...
    private static String toStr(ArrayList<Trip> input) {
